...
function metricas(){
   ...
   const characterCount  = analyzer.getcharactercount_(textoFinal);
   caracteres.innerHTML="Recuento de caracteres :"+ characterCount ;

   //contabilizar sin espacios y sin nunmero 
   const characterEs  = analyzer.getCharacterCountExcludingSpac(textoFinal);
   caracteresSe.innerHTML="Recuento de caracteres sin espacio y signos:" + characterEs ;
